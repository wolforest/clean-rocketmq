...
import cn.coderule.wolfmq.broker.domain.transaction.check.CheckerFactory;
...
import cn.coderule.wolfmq.broker.domain.transaction.receipt.ReceiptCleaner;
import cn.coderule.wolfmq.broker.domain.transaction.receipt.ReceiptRegistry;
import cn.coderule.wolfmq.broker.domain.transaction.service.BatchCommitService;
...
public class TransactionBootstrap implements Lifecycle {
    ...
    public void start() throws Exception {
        ...
        ProducerManager producerManager = BrokerContext.getBean(ProducerManager.class);
        checkService.inject(producerManager);
        checkService.start();
    }
