...
import cn.coderule.wolfmq.broker.domain.consumer.ack.AckBootstrap;
...
import cn.coderule.wolfmq.broker.domain.consumer.consumer.ConsumeHookManager;
import cn.coderule.wolfmq.broker.domain.consumer.consumer.ConsumerManager;
import cn.coderule.wolfmq.broker.domain.consumer.pop.PopBootstrap;
import cn.coderule.wolfmq.broker.domain.consumer.pop.PopService;
import cn.coderule.wolfmq.broker.domain.consumer.renew.RenewBootstrap;
import cn.coderule.wolfmq.broker.domain.consumer.revive.ReviveBootstrap;
...
public class ConsumerBootstrap implements Lifecycle {
    ...
    private void initTools() {
        ConsumerManager register = new ConsumerManager(brokerConfig);
