...
import cn.coderule.wolfmq.broker.domain.transaction.check.service.OperationMessageLoader;
import cn.coderule.wolfmq.broker.domain.transaction.check.service.PrepareMessageChecker;
...
import cn.coderule.wolfmq.domain.domain.transaction.CheckBuffer;
...
public class TransactionChecker extends ServiceThread {
    ...
    private CheckContext buildCheckContext(MessageQueue prepareQueue) {
        MessageQueue operationQueue = checkBuffer.getOrCreateOperationQueue(prepareQueue);
