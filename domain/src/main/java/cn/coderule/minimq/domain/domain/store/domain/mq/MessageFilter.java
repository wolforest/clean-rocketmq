...
import cn.coderule.minimq.domain.domain.store.domain.consumequeue.ConsumeUnit;
...
public interface MessageFilter {
     ...
     * @param unit ConsumeUnit
     */
    boolean isMatchedByConsumeQueue(Long tagsCode, ConsumeUnit unit);
