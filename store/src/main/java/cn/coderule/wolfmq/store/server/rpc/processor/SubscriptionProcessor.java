...
import cn.coderule.wolfmq.rpc.store.protocol.header.DeleteSubscriptionGroupRequestHeader;
import cn.coderule.wolfmq.rpc.store.protocol.header.GetSubscriptionGroupConfigRequestHeader;
