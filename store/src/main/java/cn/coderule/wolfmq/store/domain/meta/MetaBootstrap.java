...
import cn.coderule.wolfmq.store.api.ConsumeOffsetStoreImpl;
import cn.coderule.wolfmq.store.api.SubscriptionStoreImpl;
import cn.coderule.wolfmq.store.api.TopicStoreImpl;
...
public class MetaBootstrap implements Lifecycle {
    ...
    private void injectDependency() {
        ...
        topicService.inject(consumeQueueManager, storeRegister);
    }
