 ...
 */
package cn.coderule.minimq.rpc.rpc.protocol.codec;
...
public class RocketMQSerializable {
    ...
    public static int rocketMQProtocolEncode(RpcCommand cmd, ByteBuf out) {
    ...
    public static byte[] rocketMQProtocolEncode(RpcCommand cmd) {
        // String remark
    ...
    public static RpcCommand rocketMQProtocolDecode(final ByteBuf headerBuffer,
