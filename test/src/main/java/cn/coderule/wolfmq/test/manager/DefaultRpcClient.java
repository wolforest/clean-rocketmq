...
import org.apache.rocketmq.remoting.client.Validators;
...
/**
 * @renamed from DefaultRPCClient to DefaultRpcClient
 */
    ...
    public long queryConsumerOffset(String addr, QueryConsumerOffsetRequestHeader requestHeader) throws RemotingException, InterruptedException {
        ...
        return switch (response.getCode()) {
            case ResponseCode.SUCCESS -> {
                ...
                yield responseHeader.getOffset();
            }
            default -> throw new RemotingException(response.getCode(), response.getRemark(), addr);
        };
